---
title: 深入理解 AI Agent：设计原理与工程实践-第二章：上下文工程（转载）
date: 2026-08-25 16:32:00
tags:
  - AI Agent
  - 人工智能
  - 上下文工程
...
categories:
  - AI 技术
series: 深入理解 AI Agent：设计原理与工程实践
series_index: 3
abbrlink: ai-agents-in-depth-zh-cn-chapter-2
description: 上下文窗口、KV Cache、提示工程、Skills、状态栏与上下文压缩。
---
...
>
> 原项目采用 **Apache License 2.0** 开源许可。下方正文采用原项目 `book/` 目录的 Markdown 原文，仅做适配博客渲染的图片路径、标题属性和引用图片格式处理；未将原作内容主张为原创，请以原项目及其许可证文本为准。

> **系列导航**
>
> - [引言](/posts/ai-agents-in-depth-zh-cn-introduction/)
> - [第 1 章 AI Agent 入门](/posts/ai-agents-in-depth-zh-cn-chapter-1/)
> - [第 2 章 上下文工程](/posts/ai-agents-in-depth-zh-cn-chapter-2/)
> - [第 3 章 用户记忆和知识库](/posts/ai-agents-in-depth-zh-cn-chapter-3/)
> - [第 4 章 工具](/posts/ai-agents-in-depth-zh-cn-chapter-4/)
> - [第 5 章 Coding Agent 与通用 Agent](/posts/ai-agents-in-depth-zh-cn-chapter-5/)
> - [第 6 章 交互：观察与动作空间的扩展](/posts/ai-agents-in-depth-zh-cn-chapter-6/)
> - [第 7 章 Agent 的评估](/posts/ai-agents-in-depth-zh-cn-chapter-7/)
> - [第 8 章 模型后训练](/posts/ai-agents-in-depth-zh-cn-chapter-8/)
> - [第 9 章 Agent 的持续进化](/posts/ai-agents-in-depth-zh-cn-chapter-9/)
> - [第 10 章 多 Agent 协作](/posts/ai-agents-in-depth-zh-cn-chapter-10/)
> - [后记：回到 Agent = LLM + 上下文 + 工具](/posts/ai-agents-in-depth-zh-cn-afterword/)

> [← 上一篇：第 1 章 AI Agent 入门](/posts/ai-agents-in-depth-zh-cn-chapter-1/)
>
> [下一篇：第 3 章 用户记忆和知识库 →](/posts/ai-agents-in-depth-zh-cn-chapter-3/)
...
![图2-1 上下文窗口的构成概览](/images/ai-agents-in-depth/fig2-1.svg)
...
![图2-2 单轮 API 调用的请求与响应结构](/images/ai-agents-in-depth/fig2-2.svg)
...
![图2-3 两次模型 API 调用的完整交互序列](/images/ai-agents-in-depth/fig2-3.svg)
...
![图2-4 Agent 每次调用模型时的上下文构成](/images/ai-agents-in-depth/fig2-4.svg)
...
>
>
> ![图2-5 本地 LLM 工具调用架构](/images/ai-agents-in-depth/fig2-5.svg)
>
...
>
>
> ![图2-6 注意力机制的直观理解](/images/ai-agents-in-depth/fig2-6.svg)
>
>
...
>
>
> ![图2-7 注意力热力图可视化](/images/ai-agents-in-depth/fig2-7.png)
>
>
> 注意力热力图揭示了几个关键模式：
>
...
![图2-8 Chat Template 的 Token 结构](/images/ai-agents-in-depth/fig2-8.svg)
...
![图2-9 API 消息到模型 Token 流的转换](/images/ai-agents-in-depth/fig2-9.svg)
...
![图2-10 KV Cache 前缀复用机制](/images/ai-agents-in-depth/fig2-10.svg)
...
![图2-11 Skills 渐进式披露机制](/images/ai-agents-in-depth/fig2-11.svg)
...
![图2-12 启用 Skills 后 Agent Trajectory 的完整结构](/images/ai-agents-in-depth/fig2-12.svg){height=55%}

![图2-13 KV Cache 随 Agent Trajectory 增长的演化](/images/ai-agents-in-depth/fig2-13.svg)
...
![图2-14 Agent 状态栏架构](/images/ai-agents-in-depth/fig2-14.svg)
...
![图2-15 Agent 状态栏在 API 消息列表中的插入位置](/images/ai-agents-in-depth/fig2-15.svg)
...
![图2-16 上下文压缩策略对比](/images/ai-agents-in-depth/fig2-16.svg)
...
>
>
> ![图2-17 六种压缩策略的处理流程](/images/ai-agents-in-depth/fig2-17.svg)
>
