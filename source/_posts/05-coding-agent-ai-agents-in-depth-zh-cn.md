...
series_index: 6
abbrlink: ai-agents-in-depth-zh-cn-chapter-5
description: Coding Agent、文件系统与代码作为通用 Agent 元能力。
---
...
> [← 上一篇：第 4 章 工具](/posts/ai-agents-in-depth-zh-cn-chapter-4/)
>
> [下一篇：第 6 章 交互：观察与动作空间的扩展 →](/posts/ai-agents-in-depth-zh-cn-chapter-6/)
