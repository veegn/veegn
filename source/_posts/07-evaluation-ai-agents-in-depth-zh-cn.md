...
series_index: 8
abbrlink: ai-agents-in-depth-zh-cn-chapter-7
description: 评估环境、数据集、LLM-as-a-Judge、模型选型与评估闭环。
---
...
> [← 上一篇：第 6 章 交互：观察与动作空间的扩展](/posts/ai-agents-in-depth-zh-cn-chapter-6/)
>
> [下一篇：第 8 章 模型后训练 →](/posts/ai-agents-in-depth-zh-cn-chapter-8/)
