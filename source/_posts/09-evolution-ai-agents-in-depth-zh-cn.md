---
title: 深入理解 AI Agent：设计原理与工程实践-第九章：Agent 的持续进化（转载）
...
series_index: 10
abbrlink: ai-agents-in-depth-zh-cn-chapter-9
description: 将运行经验转化为知识、Prompt、Harness 与模型能力。
---
...
> [← 上一篇：第 8 章 模型后训练](/posts/ai-agents-in-depth-zh-cn-chapter-8/)
>
> [下一篇：第 10 章 多 Agent 协作 →](/posts/ai-agents-in-depth-zh-cn-chapter-10/)
