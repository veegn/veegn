...
series_index: 11
abbrlink: ai-agents-in-depth-zh-cn-chapter-10
description: 多 Agent 分工、协作架构、Agent 社会与 Agent 经济。
---
...
> [← 上一篇：第 9 章 Agent 的持续进化](/posts/ai-agents-in-depth-zh-cn-chapter-9/)
>
> [下一篇：后记：回到 Agent = LLM + 上下文 + 工具 →](/posts/ai-agents-in-depth-zh-cn-afterword/)
